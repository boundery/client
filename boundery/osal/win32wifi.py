        ...
        for iface in ifaces:
            ...
            try:
                ...
                for network in networks2:
                    ...
                    SSID = network.dot11Ssid.SSID[:network.dot11Ssid.SSIDLength].decode("utf-8")
                    BSSID = ':'.join('%02x' % b for b in network.dot11Bssid).upper()
                    signal_strength = network.lRssi
